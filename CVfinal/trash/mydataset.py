...
if __name__ == '__main__':
    # image_root = './dataset/processed/image/valid'
    # mask_root = './dataset/processed/mask/valid'
    # # image_root = './dataset/processed/image/train'
    # # mask_root = './dataset/processed/mask/train'
    ...
    # train_dataset = myDataset(image_root, mask_root, train_transform)
